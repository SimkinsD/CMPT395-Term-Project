...
# Generated by Django 2.0.1 on 2018-03-27 22:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(blank=True, null=True, verbose_name=['%Y-%m-%d'])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.IntegerField(blank=True, null=True)),
                ('email', models.CharField(blank=True, max_length=40)),
                ('family', models.ManyToManyField(to='user.Family')),
            ],
        ),
        migrations.AddField(
            model_name='signup',
            name='volunteer',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='user.Volunteer'),
        ),
        migrations.AddField(
            model_name='child',
            name='family',
